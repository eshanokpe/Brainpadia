...
class EditBuyPostAds extends StatelessWidget {
  final num amount;
  final num price;
  final num limitForm;
  final num limitTo;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const TAppBar(showBackArrow: true, title: 'Edit Sell PostAds '),
      body: Form(
        key: _formKey,
        child: Row(
          children: [
                          ...
                          onPressed: userState.isLoading
                              ...
                              : () async {
                                  if (_formKey.currentState!.validate()) {
                                    ...
                                    await userState.editBuyPostAds(
                                        context,
                                        p2PBuyAdsId,
