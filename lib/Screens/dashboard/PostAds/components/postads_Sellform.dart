...
class PostadsSellForm extends StatefulWidget {
  const PostadsSellForm({Key? key}) : super(key: key);

  @override
  State<PostadsSellForm> createState() => _PostadsSellFormState();
}

class _PostadsSellFormState extends State<PostadsSellForm> {
      ...
      child: Form(
        ...
        child: ListView(
          children: [
            const Center(
              child: Text(
                'Create a Sell Ads', // Replace SizedBox.shrink() with Text widget
                style: TextStyle(
                    fontSize: 18,
                    color: Colors.black,
