...
import '../editBuyPostads.dart';
import 'selldetailspostads_screen.dart';

class ViewSellPostAds extends StatelessWidget {
  const ViewSellPostAds({super.key});
    ...
    return Container(
      ...
      child: Consumer<P2PPostAdsProvider>(
        builder: (context, p2pUserSellAdsProvider, _) {
          ...
          final p2pUserSellAds = p2pUserSellAdsProvider.p2pUserSellAds;
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                final nickName =
                    p2pSellAd['bankDetails']['profile']['nickName'];
                final imageUrl =
                    p2pSellAd['bankDetails']['profile']['imageUrl'];
