import 'package:brainepadia/Screens/dashboard/PostAds/editBuyPostads.dart';
...
import 'buydetailspostads_screen.dart';
    ...
    return Container(
      ...
      child: Consumer<P2PPostAdsProvider>(
        builder: (context, p2pUserBuyAdsProvider, _) {
          final p2pUserBuyAds = p2pUserBuyAdsProvider.p2pUserBuyAds;
